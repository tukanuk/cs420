...
public class DatabaseDescription {
   ...
   public static final class Contact implements BaseColumns {
      ...
      public static final String COLUMN_PHONE_WORK = "work_phone";
      public static final String COLUMN_PHONE_CELL = "cell_phone";
      ...
      // nested class defines contents of the user table
      public static final class User implements BaseColumns {
         public static final String TABLE_NAME = "user"; // table's name
