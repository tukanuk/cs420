...
package com.david11n.addressbook.data;
...
import static com.david11n.addressbook.data.DatabaseDescription.*;
...
class AddressBookDatabaseHelper extends SQLiteOpenHelper {
   ...
   // creates the contacts and user table when the database is created
   @Override
