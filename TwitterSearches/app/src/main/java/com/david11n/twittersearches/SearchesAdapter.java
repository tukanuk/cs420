...
public class SearchesAdapter
   ...
   public static class ViewHolder extends RecyclerView.ViewHolder {
      ...
      public ViewHolder(View itemView,
         ...
         tagTime = (TextView) itemView.findViewById(R.id.tagTime);
   ...
   public void onBindViewHolder(ViewHolder holder, int position) {
      String line = tags.get(position);
      Log.e("BEN", line);
      String[] pString = line.split("\\|");
      Log.e("BEN", pString[0]);
      Log.e("BEN", pString[1]);


//     holder.tagName.setText(tags.get(position));
      holder.tagName.setText(pString[0]);
      holder.tagTime.setText(pString[1]);
