...
public class MainActivity extends AppCompatActivity
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      bundle = getIntent().getExtras(); //new
      fragBundle = new Bundle(); //new

      contactsFragment = new ContactsFragment(); //new
      fragBundle.putString("name", USERNAME); //new
      contactsFragment.setArguments(fragBundle); //new
