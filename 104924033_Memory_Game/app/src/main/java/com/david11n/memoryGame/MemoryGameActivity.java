...
public class MemoryGameActivity extends AppCompatActivity {
   ...
   // configure the memorygame Activity
   @Override
   ...
   private OnSharedPreferenceChangeListener preferencesChangeListener =
      new OnSharedPreferenceChangeListener() {
         ...
         public void onSharedPreferenceChanged(
            ...
            if (key.equals(CHOICES)) { // # of choices to display changed
            ...
            else if (key.equals(GROUPS)) { // regions to include changed
               Set<String> regions =
                  sharedPreferences.getStringSet(GROUPS, null);
               ...
               if (regions != null && regions.size() > 0) {
                  ...
                  regions.add(getString(R.string.default_element_group));
                  editor.putStringSet(GROUPS, regions);
                  editor.apply();

                  Toast.makeText(MemoryGameActivity.this,
                     R.string.default_element_group_message,
