...
class Weather {
   ...
   // constructor
   public Weather(long timeStamp, String unit, double minTemp, double maxTemp,
      ...
      this.minTemp = numberFormat.format(minTemp) + "\u00B0" + unit;
      this.maxTemp = numberFormat.format(maxTemp) + "\u00B0" + unit;
      this.humidity =
