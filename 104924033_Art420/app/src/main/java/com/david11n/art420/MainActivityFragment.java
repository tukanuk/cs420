...
// Fragment in which the Art420View is displayed
...
public class MainActivityFragment extends Fragment {
   private david11nArt david11nArt; // handles touch events and draws
   private float acceleration;
   private float currentAcceleration;
   private float lastAcceleration;
   private boolean dialogOnScreen = false;

//   private String m_Text = ""; // save dialogue text

   private ImageButton exitButton; // creates the exit button
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      // get reference to the david11nArt420View
      david11nArt = (david11nArt) view.findViewById(R.id.art420View);
...
//      exitButton.setOnClickListener(exitButtonListener);
   ...
   public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
      ...
      inflater.inflate(R.menu.david11n_fragment_menu, menu);
   }
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
      ...
      switch (item.getItemId()) {
         ...
         case R.id.save:
            ...
            return true; // consume the menu event
         case R.id.print:
            david11nArt.printImage(); // print the current images
            return true; // consume the menu event
      }
...
//          builder.setMessage("Please name your drawing");
//
...
//          builder.show();
          ...
          david11nArt.saveImage(); // save the image
      }
   }
   ...
   // returns the david11nArtView
   public david11nArt getDavid11nArt() {
      return david11nArt;
   }
