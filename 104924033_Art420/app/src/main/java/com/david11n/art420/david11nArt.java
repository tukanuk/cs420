// david11nArt.java
// Main View for the david11n art420 app.
...
public class david11nArt extends View {
   ...
   // david11nArt constructor initializes the david11nArt
   public david11nArt(Context context, AttributeSet attrs) {
   ...
   // perform custom drawing when the david11nArt is refreshed on screen
   @Override
   ...
   public void saveImage() {
      ...
      builder.show();
      // use "david11nArt" followed by current time as the image name
//      final String name = m_Text + System.currentTimeMillis() + ".jpg";
...
//      }
   ...
   public void printImage() {
      if (PrintHelper.systemSupportsPrint()) {
         ...
         printHelper.printBitmap("david11nArt Image", bitmap);
      }
      else {
